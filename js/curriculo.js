document.getElementById("formulario").addEventListener("submit", function(event) {
    ...
    const protótipo = document.getElementById("protótipo").value.split('\\').pop(); // Extrai o nome do arquivo
    ...
    const dadosHTML = `
      ...
      <p><strong>Protótipo:</strong> ${protótipo}</p>
    ...
    // Exibe os dados na seção do currículo
